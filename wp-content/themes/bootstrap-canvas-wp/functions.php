...
function bootstrapcanvaswp_scripts() {
  ...
  wp_enqueue_style( 'owltheme', get_template_directory_uri() . '/css/owltheme.css' );
...
function imagePosition($imgPos){
	...
	$pos = ($imgPos) ? $backgroundPositions[$imgPos] : $backgroundPositions['absolute_center'];
